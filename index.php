                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="urun-detay.php">
                                                                <img src="../Admin/galeri/urunler-galeri/<?php echo $urunlercek['urun_fotograf'] ?>" alt="Li's Product Image">
                                                            </a>
                                                        ...
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="urun-detay.php"><?php echo $urunlercek['urun_baslik'] ?></a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price"><?php echo $urunlercek['urun_fiyat']  ?> TL</span>
                                                                </div>
                                                            </div>
                                                            <div class="add-actions">
                                                                <ul class="add-actions-link">
                                                                    <li class="add-cart active"><a href="sepet.php">SEPETE EKLE</a></li>
