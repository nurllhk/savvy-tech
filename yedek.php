                        ...
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   <li><a class="active" data-toggle="tab" href="#li-featured-product"><span>Yeni ürünler</span></a></li>
                                   <li><a data-toggle="tab" href="#li-featured-product"><span>En sevilen</span></a></li>
                                   <li><a data-toggle="tab"  href="#li-featured-product"><span>Piyasa dostu</span></a></li>
                                </ul>               
                            </div>
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="urun-detay.php">Accusantium dolorem1</a></h4>
                                                    <div class="price-box">
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active"><a href="#">SEPETE EKLE</a></li>
                                        ...
                                        <div class="single-product-wrap">
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name" href="urun-detay.php">Mug Today is a good day</a></h4>
                                                    <div class="price-box">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="li-static-home-content">
                                <p style="color: white;" >Sale Offer<span style="color: white;" >-20% Off</span>This Week</p>
                                <h2 style="color: white;" >Featured Product</h2>
                                <h2 style="color: white;" >Meito Accessories 2018</h2>
                                <p class="schedule" style="color: white;" >
                                    Starting at
                                    <span style="color: white;" > $1209.00</span>
                                </p>
                                <div class="default-btn">
                                    <a href="shop-left-sidebar.html" class="links" style="color: white;" >ALIŞVERİŞE BAŞLA</a>
                                </div>
                            </div>
